...
The suite-level SKILL.md is the most important file in a suite. It doesn't just list components — it tells the agent _how to think_ about routing, sequencing, and combining them.
